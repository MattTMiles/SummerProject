...
for index, star in enumerate(csv):
    ...
    string="Eu4129 and Eu4205"+starID[index] + "Index: "+str(index)+" Teff: "+str(teff[index])+" SurfG: "+str(surfg[index])+" M: "+str(met[index])
    fig.suptitle(string)
    ...
    string="Eu4205 {} Index: {}".format(starID[index], str(index))+" Teff: "+str(teff[index])+" SurfG: "+str(surfg[index])+" M: "+str(met[index])
    fig.suptitle(string)
    fig.savefig("Goodfigures/Eu_doublematch_pics/{}.png".format(index))

    fig = utils.plot_spectrum(wavelengths, observed_flux, observed_ivar, model_flux)
    string="Eu"+starID[index] + "Index: " + str(index)
    fig.suptitle(string)
    fig.savefig('Goodfigures/Eu_doublematch_pics/'+str(index)+'full'+'.png')
    plt.close("all")
...
for index, star in enumerate(csv):
    if not N_Ba_doublematch[index]: continue
    ...
    string="Ba4554 and Ba4934"+starID[index] + "Index: " + str(index)+" Teff: "+str(teff[index])+" SurfG: "+str(surfg[index])+" M: "+str(met[index])
    fig.suptitle(string)
    fig.savefig('Goodfigures/Ba_doublematch_pics/' +str(index) +'.png')
    
    fig.axes[0].set_xlim(4400, 5034)
    fig.axes[1].axvline(4934, c="#666666", zorder=-1)
    string="Ba4554 and Ba4934 {} Index: {}".format(starID[index], str(index))+" Teff: "+str(teff[index])+" SurfG: "+str(surfg[index])+" M: "+str(met[index])
    fig.suptitle(string)
    fig.savefig("Goodfigures/Ba_doublematch_pics/{}.png".format(index))


    fig = utils.plot_spectrum(wavelengths, observed_flux, observed_ivar, model_flux)
    string="Ba"+starID[index] + "Index: " + str(index)
    fig.suptitle(string)
    fig.savefig('Goodfigures/Ba_doublematch_pics/'+str(index)+'full'+'.png')
    plt.close("all")
...
for index, star in enumerate(csv):
    if not N_St_doublematch[index]: continue
    ...
    string="St4077 and St4215"+starID[index] + "Index: " + str(index)+" Teff: "+str(teff[index])+" SurfG: "+str(surfg[index])+" M: "+str(met[index])
    fig.suptitle(string)
    fig.savefig('Goodfigures/Ba_doublematch_pics/' +str(index) +'.png')
    
    fig.axes[0].set_xlim(3977, 4315)
    fig.axes[1].axvline(4215, c="#666666", zorder=-1)
    string="St4077 and St4215 {} Index: {}".format(starID[index], str(index))+" Teff: "+str(teff[index])+" SurfG: "+str(surfg[index])+" M: "+str(met[index])
    fig.suptitle(string)
    fig.savefig("Goodfigures/St_doublematch_pics/{}.png".format(index))

    fig = utils.plot_spectrum(wavelengths, observed_flux, observed_ivar, model_flux)
    string="St"+starID[index] + "Index: " + str(index)
    fig.suptitle(string)
    fig.savefig('Goodfigures/St_doublematch_pics/'+str(index)+'full'+'.png')
    plt.close("all")
