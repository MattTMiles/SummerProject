...
% While which may not produce much material? Be specific!
% Also: it is almost impossible for us to distinguish an abundance signature as coming from a NS merger compared to a MRDSN, so normally they are thrown into the same bucket when discussing them. Keep that of mind.
...
% The above statement is not entirely true: there has been constant discussion about the r-process origin, but the discovery of Reticulum II marked a very interesting case where: (i) lots of r-process material was found and (ii) the environment meant that CCSN could be entirely excluded.
...
% 22 or 48? We report on 48, where 22 are more likely.
...
% What labels did Anna Ho predict? What's the typical precision of those labels?
...
% The above statement isn't true is it? Didn't you have >>48 candidates that you culled to 48, and then 22 stars looked really good by comparison?
