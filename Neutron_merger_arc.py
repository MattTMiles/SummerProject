...
data = Table.read("your-catalog.csv")
Fe_H = data["cannon_m_h"] # 
...
# Sum of your 47 stars, 
Eu47 = np.sum(Eu_mass)

# Plus the ~dozen other r-process stars known... I sent you their fehs right?
# If so then read them in  here

#Eu_previous = ....
raise DOTHISPART

Eu60 = Eu47 + Eu_previous
